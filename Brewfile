...
tap "snowflakedb/snowflake-cli", "https://github.com/snowflakedb/homebrew-snowflake-cli.git"
...
brew "mylee04/tools/claude-notify"
...
vscode "altimateai.datapilot-mcp-server-tools-ext"
